	...
	*/
	...
	if( isset($_GET['contactar']) ){
		...
		$enviar = sendMail(array(
			'destino' => 'contacto@fundaciongonzalo.com',
			'bcc' => 'fundaciongonzalo@outlook.es, fundaciongonzalo.com@gmail.com',
			'asunto' => 'Contacto desde sitio web Fundacion Gonzalo',
			'mensaje' => $emailtext,
			'from' => 'contacto@fundaciongonzalo.com',
		));
		if($enviar) echo 1;
		else echo 0;
		exit();
